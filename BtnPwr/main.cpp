...
// Daemonize if not debug mode
    ...
    if(debug==1){
      freopen( "/home/work/pwrbtn_log", "w", stdout);
      freopen( "/home/work/pwrbtn_err", "w", stderr);
    }
  ...
  //pr.waitForFinished();
    ...
    // qDebug()<<"screen"<<screen;
     ...
     //qDebug()<<"grab";
     //pm.save("/home/user/prog/dev_srv/ms.jpg");
     //qDebug()<<"save";
  QCoreApplication a(argc,argv);
  device=0; cmd=0;
  device=new TBtnBehav;
  cmd=new TcmdBehav;
  a.exec();
  } //end try
  catch(...){
